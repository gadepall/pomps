...
Despite these methodologies, a significant gap persists; existing mathematical frameworks ultimately require arbitrary aesthetic cropping in design software to finish the logo. 
...
\begin{figure}[H]
    ...
    \caption{Derived: $a=2+\sqrt{2}$, $b=\sqrt{2}$}
	\label{fig:hyper}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
