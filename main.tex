...
To plot the function $f(t)$ effectively, we define truncation points $t_1$ and $t_2$ such that a fraction $p$ (e.g., $0.99$) of the total area is retained. Given $f(t)$ from \eqref{q1} and \eqref{q2}:
\begin{align}
    f(t) = \begin{cases} 
        e^{bt}, & t < 0 \\
        e^{-at}, & t > 0 
...
\begin{align}
	t_1 &= \frac{1}{b} \ln\brak{\frac{b(1-p)}{2}}= \frac{1}{\sqrt{2}} \ln\brak{\frac{\sqrt{2}(1-0.975)}{2}} &\approx -2.8535 \\
	t_2 &= -\frac{1}{a} \ln\brak{\frac{a(1-p)}{2}}= -\frac{1}{2+\sqrt{2}} \ln\brak{\frac{(2+\sqrt{2})(1-0.975)}{2}} &\approx 0.9238
\end{align}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\columnwidth]{figs/trunc.png}
	\caption{}
